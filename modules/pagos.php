...
<head>
    ...
    <style>
        .pagos-flex-container {
            display: flex;
            gap: 2rem;
            align-items: flex-start;
        }
        .pagos-form, .pagos-lista {
            background: #fff;
            border-radius: 8px;
        ...
        .tabla-pagos .td-monto {
            font-family:monospace;
            font-size:15px;
            font-weight:600;
            color:#952d2d;
        }
        .tabla-pagos td.col-acciones {
            min-width: 85px;
        }
        /* SOLO PARA EL FORMULARIO DE PAGOS: reduce el ancho de los campos input */
        .formulario.form-pagos input[type="date"],
        .formulario.form-pagos input[type="number"],
        .formulario.form-pagos input[type="text"],
        .formulario.form-pagos select,
        .formulario.form-pagos textarea {
            width: 260px !important;
            max-width: 100%;
            display: block;
            box-sizing: border-box;
        }
        .formulario.form-pagos .form-btns {
            width: 260px;
        }
