...
// Módulo: Flujo de Caja (botones de acciones reemplazados por iconos pequeños)
// Mantengo la lógica CRUD y la mayoría del HTML/CSS que ya tenías, sólo cambié la columna "Acciones"
// en el listado para usar los iconos pequeños naranja (.btn-accion) como en los otros módulos.
...
// Acciones CRUD (idéntico a la versión funcional que tienes)
$action = $_GET['action'] ?? '';
$errors = [];
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-print">
                                            <div class="table-actions" aria-label="Acciones">
                                                <!-- Editar: ahora con enlace y icono pequeño -->
                                                ...
                                                <!-- Eliminar: mantiene POST pero usando icono pequeño -->
